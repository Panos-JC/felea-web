...
export const DashboardRoutes: React.FC<DashboardRoutesProps> = () => {
  return (
    <>
      <ProtectedRoute path="/dashboard/orders" component={OrderList} exact />
      <ProtectedRoute path="/dashboard/order/:id" component={OrderPage} exact />
